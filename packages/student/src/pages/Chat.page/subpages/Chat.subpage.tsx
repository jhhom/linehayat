...
export function ChatSubpage(props: { feedbackSubmitted: boolean }) {
  ...
  return (
    <Show when={!props.feedbackSubmitted} fallback={<FeedbackThankyou />}>
          ...
          .with("chatting", () => (
            <div>
              <Chat
                ...
                onHangup={async () => {
                  const feedbackId = await client["student/hang_up"]();
